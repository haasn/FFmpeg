...
int ff_vk_decode_prepare_frame(FFVulkanDecodeShared *ctx, AVFrame *pic,
                                    ...
                                    int *dpb_dedicate)
{
    ...
    FFVulkanExtensions *extensions = &ctx->s.extensions;
    FFVulkanFunctions *vk = &ctx->s.vkfn;
    VkVideoCapabilitiesKHR *caps = &ctx->common.caps;

    VkVideoDecodeCapabilitiesKHR *dec_caps = &ctx->dec_caps;
    VkVideoDecodeH264ProfileInfoKHR *h264_profile = &ctx->h264_profile;
    VkVideoDecodeH264ProfileInfoKHR *h265_profile = &ctx->h265_profile;
    VkVideoDecodeAV1ProfileInfoMESA *av1_profile = &ctx->av1_profile;
    VkVideoDecodeUsageInfoKHR *usage = &ctx->usage;
    VkVideoProfileInfoKHR *profile = &ctx->profile;
    VkVideoProfileListInfoKHR *profile_list = &ctx->profile_list;
...
int ff_vk_decode_init(AVCodecContext *avctx)
{
    ...
    err = vulkan_decode_check_init(avctx, avctx->hw_frames_ctx,
