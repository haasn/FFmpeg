...
static const AVOption dovi_rpu_options[] = {
    ...
    { "compression",    "DV metadata compression mode", OFFSET(compression), AV_OPT_TYPE_FLAGS, { .i64 = FF_DOVI_COMPRESS_LIMITED }, 0, UINT_MAX, FLAGS, .unit = "compression" },
        { "none",       "Don't compress metadata",      0, AV_OPT_TYPE_CONST, {.i64 = 0},                        .flags = FLAGS, .unit = "compression" },
        { "vdr",        "Compress VDR metadata",        0, AV_OPT_TYPE_CONST, {.i64 = FF_DOVI_COMPRESS_VDR},     .flags = FLAGS, .unit = "compression" },
        { "limited",    "Limited metadata compression", 0, AV_OPT_TYPE_CONST, {.i64 = FF_DOVI_COMPRESS_LIMITED}, .flags = FLAGS, .unit = "compression" },
    { NULL }
};
