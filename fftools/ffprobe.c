...
static struct section sections[] = {
    ...
    [SECTION_ID_FRAME_SIDE_DATA_COMPONENT] =      { SECTION_ID_FRAME_SIDE_DATA_COMPONENT, "component", SECTION_FLAG_HAS_VARIABLE_FIELDS, { SECTION_ID_FRAME_SIDE_DATA_PIECE_LIST, -1 }, .element_name = "side_datum" },
    ...
    [SECTION_ID_FRAME_SIDE_DATA_PIECE] =        { SECTION_ID_FRAME_SIDE_DATA_PIECE, "piece", SECTION_FLAG_HAS_VARIABLE_FIELDS, { -1 }, .element_name = "side_datum" },
