...
static bool cie_xy_equal(AVCIExy a, AVCIExy b)
{
...
SwsMatrix3x3 ff_sws_get_adaptation_matrix(AVCIExy from, AVCIExy to)
{
    ...
    AVColorPrimariesDesc csp = *av_csp_primaries_desc_from_id(AVCOL_PRI_BT709);
    csp.wp = from;
