...
#if PL_API_VER >= 269
static const struct pl_gamut_map_function * const gamut_funcs[GAMUT_MAP_COUNT] = {
    [GAMUT_MAP_CLIP]        = &pl_gamut_map_clip,
    [GAMUT_MAP_PERCEPTUAL]  = &pl_gamut_map_perceptual,
    [GAMUT_MAP_RELATIVE]    = &pl_gamut_map_relative,
    [GAMUT_MAP_SATURATION]  = &pl_gamut_map_saturation,
    [GAMUT_MAP_ABSOLUTE]    = &pl_gamut_map_absolute,
    [GAMUT_MAP_DESATURATE]  = &pl_gamut_map_desaturate,
    [GAMUT_MAP_DARKEN]      = &pl_gamut_map_darken,
    [GAMUT_MAP_HIGHLIGHT]   = &pl_gamut_map_highlight,
    [GAMUT_MAP_LINEAR]      = &pl_gamut_map_linear,
};
#else
static const enum pl_gamut_mode gamut_modes[GAMUT_MAP_COUNT] = {
    [GAMUT_MAP_CLIP]        = PL_GAMUT_CLIP,
    [GAMUT_MAP_PERCEPTUAL]  = PL_GAMUT_CLIP,
    [GAMUT_MAP_DESATURATE]  = PL_GAMUT_DESATURATE,
    [GAMUT_MAP_DARKEN]      = PL_GAMUT_DARKEN,
    [GAMUT_MAP_HIGHLIGHT]   = PL_GAMUT_WARN,
    /* Everything else defaults to PL_GAMUT_CLIP */
};

static const enum pl_rendering_intent intents[GAMUT_MAP_COUNT] = {
    [GAMUT_MAP_SATURATION]  = PL_INTENT_SATURATION,
    [GAMUT_MAP_RELATIVE]    = PL_INTENT_RELATIVE_COLORIMETRIC,
    [GAMUT_MAP_ABSOLUTE]    = PL_INTENT_ABSOLUTE_COLORIMETRIC,
    /* Everything else defaults to PL_INTENT_PERCEPTUAL */
};
#endif
